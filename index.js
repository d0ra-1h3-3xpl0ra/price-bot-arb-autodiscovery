...
// We need js contract version of exchanges to effectivley add further exchanges
...
// exchangeAddress => async uniswapFactory Contract, taking our desired output tokenaddress and quering then calling the necessary exchange address
// exchangeContract =>  
async function checkPair(args) {
  ...
  // Add more exchanges here when more exchange results required, 
  // also Import specific ExchangeContracts or else no logic...
...
// Custom static formatted output for uniswap - kyber exchange swaps 
  console.table([{
...
// Slippage in Kyber, 
// Kyber Minimum Return Value == Slippage 
// Also count on the minimum return to be the actuall return

let priceMonitor
let monitoringPrice = false

// new tolkens can be found at https://etherscan.io/tokens where we need to add the token address and symbol in any new comparison block we would want to add.  
...
async function monitorPrice() {
  ...
  try {
    ...
    // hardcoded values and contract/token addresses to fetch price data from and to compare with 
    // limited to functionality of uniswap and kyber, taking ether as input token
    // if inputtoken should be sth. else, upadte checkPair fx to desired token and exchange... 
    ...
    await checkPair({
        inputTokenSymbol: 'ETH',
        inputTokenAddress: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
        outputTokenSymbol: 'FTM',
        outputTokenAddress: '0x4E15361FD6b4BB609Fa63C81A2be19d873717870',
        inputAmount: web3.utils.toWei('1', 'ETHER')
    })
